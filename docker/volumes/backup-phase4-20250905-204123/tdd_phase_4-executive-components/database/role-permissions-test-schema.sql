...
-- Insert test data for validation (FIXED ARRAY SYNTAX)
INSERT INTO test_user_roles (user_id, role_type, permissions) VALUES
  ('11111111-1111-1111-1111-111111111111', 'inventory_staff', ARRAY['view_inventory', 'update_stock']),
  ('22222222-2222-2222-2222-222222222222', 'marketing_staff', ARRAY['update_product_content', 'create_promotions']),
  ('33333333-3333-3333-3333-333333333333', 'executive', ARRAY['view_all_analytics']),
  ('44444444-4444-4444-4444-444444444444', 'admin', ARRAY['manage_users', 'manage_roles']);
