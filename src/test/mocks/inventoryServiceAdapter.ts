/**
 * Adapter to bridge the gap between hook tests expectations and gold standard service
 * This allows us to run the hook tests without modifying the implementation
 */
...
// Mock adapter for testing - bridges between hook expectations and actual service
