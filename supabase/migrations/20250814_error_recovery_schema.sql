...
-- Indexes for error_recovery_log table
CREATE INDEX IF NOT EXISTS idx_error_recovery_log_error_type ON error_recovery_log(error_type);
CREATE INDEX IF NOT EXISTS idx_error_recovery_log_order_id ON error_recovery_log(order_id);
CREATE INDEX IF NOT EXISTS idx_error_recovery_log_user_id ON error_recovery_log(user_id);
CREATE INDEX IF NOT EXISTS idx_error_recovery_log_status ON error_recovery_log(status);
CREATE INDEX IF NOT EXISTS idx_error_recovery_log_created_at ON error_recovery_log(created_at);
...
-- Indexes for pickup_reschedule_log table
CREATE INDEX IF NOT EXISTS idx_pickup_reschedule_order_id ON pickup_reschedule_log(order_id);
CREATE INDEX IF NOT EXISTS idx_pickup_reschedule_user_id ON pickup_reschedule_log(user_id);
CREATE INDEX IF NOT EXISTS idx_pickup_reschedule_status ON pickup_reschedule_log(status);
CREATE INDEX IF NOT EXISTS idx_pickup_reschedule_created_at ON pickup_reschedule_log(created_at);
...
-- Indexes for no_show_log table
CREATE INDEX IF NOT EXISTS idx_no_show_log_order_id ON no_show_log(order_id);
CREATE INDEX IF NOT EXISTS idx_no_show_log_user_id ON no_show_log(user_id);
CREATE INDEX IF NOT EXISTS idx_no_show_log_status ON no_show_log(processing_status);
CREATE INDEX IF NOT EXISTS idx_no_show_log_detected_at ON no_show_log(detected_at);
